...
namespace SvgViewer
{
    ...
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        ...
        private readonly SvgViewerPackage _editorPackage;
        private ServiceProvider _vsServiceProvider;


        public EditorFactory(SvgViewerPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = PackageGuids.guidEditorFactory;// GuidList.guidVsTemplateDesignerEditorFactory;
            pgrfCDW = 0;
            ...
            if (punkDocDataExisting == IntPtr.Zero)
            {
                ...
                try
                {
                    ...
                    if (localRegistry != null)
                    {
                        ...
                        if (objWSite != null)
                        {
                            var oleServiceProvider = (Microsoft.VisualStudio.OLE.Interop.IServiceProvider)GetService(typeof(Microsoft.VisualStudio.OLE.Interop.IServiceProvider));
            ...
            var NewEditor = new EditorPane(_editorPackage, pszMkDocument, textBuffer);
            ppunkDocView = Marshal.GetIUnknownForObject(NewEditor);
            ppunkDocData = Marshal.GetIUnknownForObject(textBuffer);
            pbstrEditorCaption = " (Rendered)";
            return VSConstants.S_OK;
        }
